...
{{--<nav class=" bg-blue-500 h-screen py-12 px-8 flex flex-col justify-center">--}}
<nav class="w-1/5 bg-blue-500 h-screen py-12 px-8 flex flex-col justify-center">
    ...
    <div class="sm:block pt-5">
        <div class="flex flex-col">
            ...
            <a href="{{ route('alerts') }}" class="relative inline-flex {{ request()->routeIs('alerts') ? $active : $default }}">
                <span>Alerts</span>
                <span class="ml-2 inline-flex items-center justify-center bg-red-500 h-6 w-6 text-white text-xs rounded-full">{{ session()->get('alerts') }}</span>
            </a>
